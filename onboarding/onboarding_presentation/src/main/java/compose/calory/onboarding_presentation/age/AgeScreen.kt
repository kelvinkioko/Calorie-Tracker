...
import compose.calory.onboarding_presentation.components.UnitTextField
...
fun AgeScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = coreRes.string.whats_your_age),
            ...
            UnitTextField(
                ...
                unit = stringResource(id = coreRes.string.years)
            )
        }
        ActionButton(
